...
$(function(){
    var ie = (function(){
        ...
        if (msie > 0) rv = parseInt(ua.substring(msie + 5, ua.indexOf('.', msie)), 10);
        else if (trident > 0){
    ...
    document.getElementById('spin-dalje').addEventListener('click', function(){
        if(window.innerWidth>768){enable_scroll();toggle('reveal')}
    })
});
/*scrol-function end::*/
